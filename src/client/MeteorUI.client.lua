...
frame.Size = UDim2.fromOffset(430, 92)
frame.AnchorPoint = Vector2.new(0.5, 0)
frame.Position = UDim2.new(0.5, 0, 0, 220)
frame.BackgroundColor3 = Color3.fromRGB(51, 34, 31)
frame.Visible = false
frame.Parent = gui
...
title.Text = "GIANT METEOR EVENT"
title.TextColor3 = Color3.fromRGB(255, 135, 59)
...
barBg.Position = UDim2.fromOffset(14, 49)
barBg.BackgroundColor3 = Color3.fromRGB(22, 22, 26)
barBg.Parent = frame
local bgCorner = Instance.new("UICorner"); bgCorner.CornerRadius = UDim.new(1,0); bgCorner.Parent = barBg

local fill = Instance.new("Frame")
fill.Size = UDim2.fromScale(1,1)
fill.BackgroundColor3 = Color3.fromRGB(255, 95, 36)
fill.Parent = barBg
...
toast.Size = UDim2.fromOffset(420, 72)
toast.AnchorPoint = Vector2.new(0.5,0.5)
toast.Position = UDim2.new(0.5,0,0.28,0)
toast.BackgroundColor3 = Color3.fromRGB(74, 46, 36)
...
stateRemote.OnClientEvent:Connect(function(state, health, maxHealth)
    ...
    elseif state == "DEFEATED" then
        hpText.Text = "METEOR DESTROYED!"
        fill.Size = UDim2.fromScale(0,1)
        task.delay(2.5, function() frame.Visible = false end)
        return
    end
...
feedbackRemote.OnClientEvent:Connect(function(kind, gems, share)
    if kind == "REWARD" then
        showToast(string.format("METEOR REWARD  +%d GEMS\nCONTRIBUTION %.1f%%", tonumber(gems) or 0, (tonumber(share) or 0) * 100))
    end
end)
